                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4 col-xs-b15 col-md-b0">
                            <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(assets/img/background-5.jpg);">
                        ...
                        <div class="col-md-4 col-xs-b15 col-md-b0">
                            <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(assets/img/background-6.jpg);">
                                <div class="valign-middle-cell">
                                    <div class="valign-middle-content">
                        ...
                        <div class="col-md-4 col-xs-b15 col-md-b0">
                            <div class="banner-shortcode style-4 rounded-image text-center" style="background-image: url(assets/img/background-7.jpg);">
                                <div class="valign-middle-cell">
                                    <div class="valign-middle-content">
